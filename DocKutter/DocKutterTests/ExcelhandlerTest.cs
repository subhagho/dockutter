    ...
    public class ExcelHandlerTest
    {
        ...
        public void ConvertToPDF()
        {
            try
            {
                ...
                events.Add(handler.Run(DocRequestHandler.DOC_HANDLER_EXCEL, SOURCE_FILE, outDir, responseHandler));
                events.Add(handler.Run(DocRequestHandler.DOC_HANDLER_EXCEL, SOURCE_FILE_GEAR_CHARTS, outDir, responseHandler));
                events.Add(handler.Run(DocRequestHandler.DOC_HANDLER_EXCEL, SOURCE_FILE_COUNTRY_CHARTS, outDir, responseHandler));
